...
app_ui <- function(request) {
  tagList(
    ...
    dashboardPage(
      #Header----------------------------------------------------
      header = dashboardHeader(title = "KVFinder-web service",
                               titleWidth = NULL,
                               disable = FALSE,
                               .list = NULL,
                               skin = "light",
       ...
       body = dashboardBody(
               ...
               tabItems(
                ...
                #1st tab -> Run KVFinder
                  tabItem(tabName = "run_kv_sidebar",
                  #Create jumbotron
                  create_jumbotron(),
                  #-------------------------------------------
                  ...
                  fluidRow(
                    ...
                    column(7,
                           fluidRow(
                             NGLVieweROutput("structure", width = "100%", height = "400px")
                           ),
                           fluidRow(
                          ...
                          fluidRow(
                            column(5,
                                   bs4Card(
                                     ...
                                     headerBorder = TRUE,
                                     width = 11,
                                     textInput(inputId = "insert_ID",
                                               label = "Insert the run ID to get results",
                                               placeholder = "ID number"),
                                     actionButton(inputId = "check_loc_pg2",
                                                  label = "Get results",
